...
import minnet001 from '@assets/img/kmom01/KlassdiagramKmom01Uppgift_70procent.png';
...
Filen ska namnges BusStop.cs och ingå i dotnet-projktet Searching. Klassen ska ingå i ett namespace med namnet `Searching`.

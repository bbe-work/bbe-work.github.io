...
Tänk på att du eventuellt kan behöva anpassa metoden som ska läsa från fil avseende access (private eller public) och om den ska tillhöra en klass eller objekt.   
...
Även här gäller det att det behövs minst 5 olika exekveringar som underlag för att beräkna ett medelvärde på antalet jämförelser för de osorterade arrayerna.   

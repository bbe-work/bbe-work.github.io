...
För att resultatet av sortering av de osorterade BusStop-objekten ska blir relevant behöver du göra minst 5 olika exekveringar med olika ordning i arrayerna. Ett tips är att blanda objekten inför varje ny sortering. När dessa körningar genomförts bestämmer du medelvärdet av antalet jämförelser.
...
## VAD SKA DE LÄMNA IN ? En tabell med resultaten och en reflektion över dessa som kan användas som del i kodintervjun?
- 

...
import bubbleSortPass01 from '@assets/img/kmom02/BubbelSortPass01.png';
...
/>
{/*
![Första passet i bubbelsort](/images/BubblesortPass01.png)
*/}

Vi kör nästa pass på samma sätt.

{/*
![Andra passet i bubbelsort](/images/BubblesortPass02.png)
*/}
...
*Anm: Den inre for-loopen kan "kortas" ner så att den inte löper hela vägen utan stannar ett steg tidigare för varje ny omgång (elementen kommer ju att vara sorterade "uppifrån och ner" och denna del ökas med ett element varje pass)*  
...
{/*
![Första passet i selectionsort](/images/SelectionsortPass01.png)
*/}
Nu fortsätter algoritmen på samma sätt men med start på index 1 (här börjar den osorterade delen).

{/*
![Andra passet i selectionsort](/images/SelectionsortPass02.png)
*/}
...
{/*
![Första passet i insertionsort](/images/InsertionssortPass01.png)
*/}
...
{/*
![Andra passet i insertionsort](/images/InsertionssortPass02.png)
*/}
